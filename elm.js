...
var _user$project$Grid$getWithCoords = F3(
	function (y, x, grid) {
		var _p17 = A3(_user$project$Grid$get, y, x, grid);
		if (_p17.ctor === 'Nothing') {
			return _elm_lang$core$Maybe$Nothing;
		} else {
			return _elm_lang$core$Maybe$Just(
				{ctor: '_Tuple3', _0: _p17._0, _1: y, _2: x});
		}
	});
...
var _user$project$Grid$balloon = F3(
	function (wid, grid, cells) {
		var fn = function (_p18) {
			var _p19 = _p18;
			return A3(_user$project$Grid$getNeighbors, _p19._1, _p19._2, grid);
		};
...
var _user$project$Grid$getContiguousRecurs = F4(
	function (queue, visited, results, grid) {
		getContiguousRecurs:
		while (true) {
			var _p29 = _user$project$Queue$deq(queue);
			var cellyx = _p29._0;
			var newQueue = _p29._1;
			var _p30 = cellyx;
			if (_p30.ctor === 'Nothing') {
				...
				var _p36 = _p30._0._1;
				var _p35 = _p30._0._2;
				var isMatch = A3(_user$project$Grid$notAdjacentToBomb, _p36, _p35, grid);
				var cellYX = {ctor: '_Tuple3', _0: _p30._0._0, _1: _p36, _2: _p35};
				var nextResults = isMatch ? A2(_elm_lang$core$List_ops['::'], cellYX, results) : results;
				var filterFn = function (_p31) {
					var _p32 = _p31;
					return _elm_lang$core$Basics$not(
						A2(
							_elm_lang$core$Set$member,
							{ctor: '_Tuple2', _0: _p32._1, _1: _p32._2},
							visited));
				};
				var neighbors = A3(_user$project$Grid$getNeighbors, _p36, _p35, grid);
				var unvisitedNeighbors = A2(_elm_lang$core$List$filter, filterFn, neighbors);
				var sdfsd = A2(
					_elm_lang$core$List$map,
					function (_p33) {
						var _p34 = _p33;
						return {ctor: '_Tuple2', _0: _p34._1, _1: _p34._2};
					},
					unvisitedNeighbors);
...
var _user$project$Grid$flag = F3(
	function (y, x, grid) {
		var _p44 = A3(_user$project$Grid$get, y, x, grid);
		if (_p44.ctor === 'Nothing') {
			return grid;
		} else {
	...
	function (y, x, grid) {
		if (A3(_user$project$Grid$isFlagged, y, x, grid)) {
			...
			var fn = function (_p53) {
				var _p54 = _p53;
				return A3(_user$project$Grid$bordersEmpty, _p54._1, _p54._2, newGrid);
			};
	...
	function (neighbors, grid) {
		...
		while (true) {
			...
			if (_p55.ctor === '[]') {
				...
				var newGrid = A3(_user$project$Grid$uncoverAll, _p55._0._1, _p55._0._2, grid);
...
var _user$project$Main$init = {
	ctor: '_Tuple2',
	_0: A2(_user$project$Grid$create, _user$project$Main$gridHeight, _user$project$Main$gridWidth),
...
var _user$project$Main$update = F2(
	function (msg, grid) {
		...
		switch (_p1.ctor) {
			case 'None':
				return {ctor: '_Tuple2', _0: grid, _1: _elm_lang$core$Platform_Cmd$none};
			case 'Restart':
				return {
					ctor: '_Tuple2',
					_0: A2(_user$project$Grid$create, _user$project$Main$gridHeight, _user$project$Main$gridWidth),
			...
			case 'Flag':
				return {
					ctor: '_Tuple2',
					_0: A3(_user$project$Grid$flag, _p1._0, _p1._1, grid),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			case 'Plant':
				var _p3 = _p1._0;
				...
				return {
					...
					_1: A2(
						...
						A4(_user$project$Grid$plantBombs, _p3, _p2, _user$project$Main$bombCount, grid))
				};
			case 'SetPlanted':
				var _p7 = _p1._1;
				var _p6 = _p1._2;
				...
				if (_p4.ctor === 'Nothing') {
					...
					return _p4._0.hasBomb ? {
						...
						_1: A2(
							...
							A4(_user$project$Grid$plantBombs, _p7, _p6, _user$project$Main$bombCount, grid))
					} : {
						ctor: '_Tuple2',
						_0: A3(_user$project$Grid$uncoverAll, _p7, _p6, _p5),
						_1: _elm_lang$core$Platform_Cmd$none
					};
				}
			case 'Clear':
				return {
					ctor: '_Tuple2',
					_0: A3(_user$project$Grid$uncoverAll, _p1._0, _p1._1, grid),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			default:
				return {
					ctor: '_Tuple2',
					_0: A3(_user$project$Grid$neighborClear, _p1._0, _p1._1, grid),
					_1: _elm_lang$core$Platform_Cmd$none
				};
		}
	});
...
var _user$project$Main$view = function (grid) {
	var remainingCount = _user$project$Grid$unclearedMineCount(grid);
	var noneUncovered = _user$project$Grid$noneUncovered(grid);
	var isWin = _user$project$Grid$isWin(grid);
	var isBombed = _user$project$Grid$isBombed(grid);
	return A2(
