...
var _user$project$BombIndex$annotate = F2(
	function (colCount, bombIndex) {
		return A2(
			_elm_lang$core$List$map,
			function (_p0) {
				var _p1 = _p0;
				...
				return {
					...
					_0: _p1._1,
					_1: (_p2 / colCount) | 0,
					_2: A2(_elm_lang$core$Basics_ops['%'], _p2, colCount)
				};
			},
			_elm_lang$core$Array$toIndexedList(bombIndex));
	});
var _user$project$BombIndex$unshuffledBombs = F2(
	function (indexLen, bombCount) {
		var limitedBombCount = (_elm_lang$core$Native_Utils.cmp(bombCount, indexLen) < 0) ? bombCount : (indexLen - 1);
		return A2(
			_elm_lang$core$Array$initialize,
			indexLen,
			function (idx) {
				return _elm_lang$core$Native_Utils.cmp(idx, limitedBombCount) < 0;
			});
	});
var _user$project$BombIndex$create = F3(
	function (rowCount, colCount, bombCount) {
		var unshuffled = A2(_user$project$BombIndex$unshuffledBombs, rowCount * colCount, bombCount);
		var shuffler = _elm_community$random_extra$Random_Array$shuffle(unshuffled);
		return A2(
			_elm_lang$core$Random$map,
			function (shuffled) {
				return A2(_user$project$BombIndex$annotate, colCount, shuffled);
			},
			shuffler);
	});
...
var _user$project$Grid$set = F4(
	function (y, x, newCell, grid) {
		var _p2 = A2(_elm_lang$core$Array$get, y, grid);
		if (_p2.ctor === 'Nothing') {
			return grid;
		} else {
			var _p4 = _p2._0;
			var _p3 = A2(_elm_lang$core$Array$get, x, _p4);
			if (_p3.ctor === 'Nothing') {
				return grid;
			} else {
				var newRow = A3(_elm_lang$core$Array$set, x, newCell, _p4);
				return A3(_elm_lang$core$Array$set, y, newRow, grid);
			}
		}
	});
var _user$project$Grid$mapWithCounter = F4(
	function (count, newArr, fn, oldArr) {
		mapWithCounter:
		while (true) {
			var _p5 = _user$project$Grid$shift(oldArr);
			var item = _p5._0;
			var oldArrX = _p5._1;
			var _p6 = item;
			if (_p6.ctor === 'Just') {
...
var _user$project$Grid$mapc = F2(
	function (fn, arr) {
...
var _user$project$Grid$every = F2(
	function (fn, grid) {
		return A3(
			...
			F2(
				function (row, soFar) {
					return soFar && A2(_user$project$Grid$everyInRow, fn, row);
				}),
			true,
			grid);
	});
	...
	function (dupes, noDupes, deduper) {
		...
		while (true) {
			...
			if (_p9.ctor === '[]') {
				...
				var _p11 = _p9._0._1;
				var _p10 = _p9._0._2;
				var cellYX = {ctor: '_Tuple3', _0: _p9._0._0, _1: _p11, _2: _p10};
				var isDupe = A2(
...
var _user$project$Grid$addVisits = F2(
...
var _user$project$Grid$get = F3(
	function (y, x, grid) {
		var _p14 = A2(_elm_lang$core$Array$get, y, grid);
		if (_p14.ctor === 'Just') {
			return A2(_elm_lang$core$Array$get, x, _p14._0);
		} else {
			return _elm_lang$core$Maybe$Nothing;
		}
	});
var _user$project$Grid$getWithCoords = F3(
	function (y, x, grid) {
		var _p15 = A3(_user$project$Grid$get, y, x, grid);
		if (_p15.ctor === 'Nothing') {
			return _elm_lang$core$Maybe$Nothing;
		} else {
			return _elm_lang$core$Maybe$Just(
				{ctor: '_Tuple3', _0: _p15._0, _1: y, _2: x});
		}
	});
var _user$project$Grid$getNeighbors = F3(
	function (y, x, grid) {
		var xDn = x - 1;
		var xUp = x + 1;
		var yDn = y - 1;
		...
		var list = _elm_lang$core$Native_List.fromArray(
			[
				A3(_user$project$Grid$getWithCoords, yDn, xDn, grid),
				A3(_user$project$Grid$getWithCoords, yDn, x, grid),
				A3(_user$project$Grid$getWithCoords, yDn, xUp, grid),
				A3(_user$project$Grid$getWithCoords, y, xUp, grid),
				A3(_user$project$Grid$getWithCoords, yUp, xUp, grid),
				A3(_user$project$Grid$getWithCoords, yUp, x, grid),
				A3(_user$project$Grid$getWithCoords, yUp, xDn, grid),
				A3(_user$project$Grid$getWithCoords, y, xDn, grid)
			]);
		return A2(_elm_lang$core$List$filterMap, _elm_lang$core$Basics$identity, list);
	});
var _user$project$Grid$balloon = F3(
	function (wid, grid, cells) {
		var fn = function (_p16) {
			var _p17 = _p16;
			return A3(_user$project$Grid$getNeighbors, _p17._1, _p17._2, grid);
		};
		var concatted = A2(_elm_lang$core$List$concatMap, fn, cells);
		var appended = _elm_lang$core$Native_Utils.eq(
			_elm_lang$core$List$length(cells),
			1) ? A2(_elm_lang$core$List$append, cells, concatted) : concatted;
		return A3(
			_user$project$Grid$dedupe,
			appended,
			_elm_lang$core$Native_List.fromArray(
				[]),
...
var _user$project$Grid$isCleared = F3(
	function (y, x, grid) {
		var _p18 = A3(_user$project$Grid$get, y, x, grid);
		if (_p18.ctor === 'Nothing') {
			return false;
		} else {
			var _p19 = _p18._0.status;
			switch (_p19.ctor) {
				case 'Flagged':
					return false;
				case 'Covered':
	...
	function (bombIndex, grid) {
		...
		while (true) {
			...
			if (_p23.ctor === '[]') {
				...
				var newGrid = A4(_user$project$Grid$setBomb, _p23._0._1, _p23._0._2, _p23._0._0, grid);
				var _v26 = _p23._1,
					_v27 = newGrid;
				bombIndex = _v26;
				grid = _v27;
...
var _user$project$Grid$setStatus = F4(
	function (y, x, status, grid) {
		var _p24 = A3(_user$project$Grid$get, y, x, grid);
...
var _user$project$Grid$notAdjacentToBomb = F3(
	function (y, x, grid) {
		var _p27 = A3(_user$project$Grid$get, y, x, grid);
		if (_p27.ctor === 'Nothing') {
			return true;
		} else {
			return _elm_lang$core$Basics$not(_p27._0.hasBomb) && _elm_lang$core$Native_Utils.eq(
				A3(_user$project$Grid$countNeighborMines, y, x, grid),
				0);
		}
	});
var _user$project$Grid$bordersEmpty = F3(
	function (y, x, grid) {
		var anyFn = function (_p28) {
			var _p29 = _p28;
			return A3(_user$project$Grid$notAdjacentToBomb, _p29._1, _p29._2, grid);
		};
		var neighbors = A3(_user$project$Grid$getNeighbors, y, x, grid);
...
var _user$project$Grid$getContiguousRecurs = F4(
	function (queue, visited, results, grid) {
		getContiguousRecurs:
		while (true) {
			var _p30 = _user$project$Queue$deq(queue);
			var cellyx = _p30._0;
			var newQueue = _p30._1;
			var _p31 = cellyx;
			if (_p31.ctor === 'Nothing') {
				return A3(
					_user$project$Grid$balloon,
					_user$project$Grid$width(grid),
					grid,
					results);
			} else {
				var _p37 = _p31._0._1;
				var _p36 = _p31._0._2;
				var isMatch = A3(_user$project$Grid$notAdjacentToBomb, _p37, _p36, grid);
				var cellYX = {ctor: '_Tuple3', _0: _p31._0._0, _1: _p37, _2: _p36};
				var nextResults = isMatch ? A2(_elm_lang$core$List_ops['::'], cellYX, results) : results;
				var filterFn = function (_p32) {
					var _p33 = _p32;
					return _elm_lang$core$Basics$not(
						A2(
							_elm_lang$core$Set$member,
							{ctor: '_Tuple2', _0: _p33._1, _1: _p33._2},
							visited));
				};
				var neighbors = A3(_user$project$Grid$getNeighbors, _p37, _p36, grid);
				var unvisitedNeighbors = A2(_elm_lang$core$List$filter, filterFn, neighbors);
				var sdfsd = A2(
					_elm_lang$core$List$map,
					function (_p34) {
						var _p35 = _p34;
						return {ctor: '_Tuple2', _0: _p35._1, _1: _p35._2};
					},
					unvisitedNeighbors);
...
var _user$project$Grid$getZeroCell = F3(
	function (y, x, grid) {
		var _p38 = A3(_user$project$Grid$get, y, x, grid);
		if (_p38.ctor === 'Nothing') {
			return _elm_lang$core$Maybe$Nothing;
		} else {
			if (A3(_user$project$Grid$notAdjacentToBomb, y, x, grid)) {
				return _elm_lang$core$Maybe$Just(
					{ctor: '_Tuple3', _0: _p38._0, _1: y, _2: x});
			} else {
				var findFn = function (_p39) {
					var _p40 = _p39;
					return A3(_user$project$Grid$notAdjacentToBomb, _p40._1, _p40._2, grid);
				};
				var neighbors = A3(_user$project$Grid$getNeighbors, y, x, grid);
...
var _user$project$Grid$getContiguous = F3(
	function (y, x, grid) {
		var _p41 = A3(_user$project$Grid$get, y, x, grid);
		if (_p41.ctor === 'Nothing') {
			return _elm_lang$core$Native_List.fromArray(
				[]);
		} else {
			var originCellYX = {ctor: '_Tuple3', _0: _p41._0, _1: y, _2: x};
			var _p42 = A3(_user$project$Grid$getZeroCell, y, x, grid);
			if (_p42.ctor === 'Nothing') {
				...
				var queue = _user$project$Queue$singleton(
					{ctor: '_Tuple3', _0: _p42._0._0, _1: _p44, _2: _p43});
...
var _user$project$Grid$createCell = F2(
	function (y, x) {
		return A2(_user$project$Grid$Cell, _user$project$Grid$Covered, false);
	});
var _user$project$Grid$createRow = F2(
	function (y, xLen) {
		return A2(
			_elm_lang$core$Array$initialize,
			xLen,
			function (x) {
				return A2(_user$project$Grid$createCell, y, x);
			});
	});
var _user$project$Grid$create = F2(
	function (yLen, xLen) {
		return A2(
			_elm_lang$core$Array$initialize,
			yLen,
...
var _user$project$Grid$flag = F3(
	function (y, x, grid) {
		var _p45 = A3(_user$project$Grid$get, y, x, grid);
		if (_p45.ctor === 'Nothing') {
			return grid;
		} else {
			var _p46 = _p45._0.status;
			switch (_p46.ctor) {
				case 'Flagged':
...
var _user$project$Grid$hasNeighborFlags = F3(
	function (y, x, grid) {
		var fn = function (_p47) {
			var _p48 = _p47;
			return _elm_lang$core$Native_Utils.eq(_p48._0.status, _user$project$Grid$Flagged);
		};
		var neighbors = A3(_user$project$Grid$getNeighbors, y, x, grid);
...
var _user$project$Grid$neighborFlagCount = F3(
	function (y, x, grid) {
		var fn = F2(
			function (_p49, tally) {
				var _p50 = _p49;
				return _elm_lang$core$Native_Utils.eq(_p50._0.status, _user$project$Grid$Flagged) ? (tally + 1) : tally;
			});
		var neighbors = A3(_user$project$Grid$getNeighbors, y, x, grid);
...
var _user$project$Grid$uncover = F3(
	function (y, x, grid) {
		var _p51 = A3(_user$project$Grid$get, y, x, grid);
		if (_p51.ctor === 'Just') {
...
var _user$project$Grid$uncoverAllRecurs = F4(
	function (y, x, contiguous, grid) {
		uncoverAllRecurs:
		while (true) {
			var _p52 = contiguous;
			if (_p52.ctor === '::') {
				...
				var yy = _p53._1;
				var xx = _p53._2;
				var newGrid = A3(_user$project$Grid$uncover, yy, xx, grid);
				var _v49 = yy,
					_v50 = xx,
					_v51 = _p52._1,
					_v52 = newGrid;
				...
				contiguous = _v51;
				grid = _v52;
				continue uncoverAllRecurs;
			} else {
				return grid;
			}
		}
	});
var _user$project$Grid$uncoverAll = F3(
	function (y, x, grid) {
		if (A3(_user$project$Grid$isFlagged, y, x, grid)) {
			return grid;
		} else {
			var newGrid = A3(_user$project$Grid$uncover, y, x, grid);
			var fn = function (_p54) {
				var _p55 = _p54;
				return A3(_user$project$Grid$bordersEmpty, _p55._1, _p55._2, newGrid);
			};
			var contiguous = A3(_user$project$Grid$getContiguous, y, x, newGrid);
	...
	function (neighbors, grid) {
		...
		while (true) {
			...
			if (_p56.ctor === '[]') {
				...
				var newGrid = A3(_user$project$Grid$uncoverAll, _p56._0._1, _p56._0._2, grid);
				if (_user$project$Grid$isBombed(newGrid)) {
					return newGrid;
				} else {
					var _v55 = _p56._1,
						_v56 = newGrid;
					neighbors = _v55;
					grid = _v56;
					continue clearAllList;
				}
			}
		}
	});
var _user$project$Grid$neighborClear = F3(
	function (y, x, grid) {
		if (A3(_user$project$Grid$isCleared, y, x, grid) && (A3(_user$project$Grid$hasNeighborMines, y, x, grid) && _elm_lang$core$Native_Utils.eq(
			A3(_user$project$Grid$neighborFlagCount, y, x, grid),
			A3(_user$project$Grid$countNeighborMines, y, x, grid)))) {
			var neighbors = A3(_user$project$Grid$getNeighbors, y, x, grid);
			return A2(_user$project$Grid$clearAllList, neighbors, grid);
		} else {
			return grid;
		}
	});
...
var _user$project$Main$cellClearedClasses = _elm_lang$html$Html_Attributes$classList(
	A2(
		_elm_lang$core$List$append,
		_elm_lang$core$Native_List.fromArray(
			[
				{ctor: '_Tuple2', _0: 'cleared', _1: true}
			]),
		_user$project$Main$cellBaseClasses));
var _user$project$Main$cellBombedClasses = _elm_lang$html$Html_Attributes$classList(
	A2(
		_elm_lang$core$List$append,
		_elm_lang$core$Native_List.fromArray(
			[
...
var _user$project$Main$cellFlaggedClasses = _elm_lang$html$Html_Attributes$classList(
	A2(
		...
		_elm_lang$core$Native_List.fromArray(
			[
				{ctor: '_Tuple2', _0: 'flagged', _1: true}
			]),
		_user$project$Main$cellBaseClasses));
var _user$project$Main$cellCoveredClasses = _elm_lang$html$Html_Attributes$classList(
	A2(
		_elm_lang$core$List$append,
		_elm_lang$core$Native_List.fromArray(
			[
...
var _user$project$Main$leftPadMax = F4(
	function (padder, width, n, maximum) {
		var maxxed = _elm_lang$core$Basics$toString(
			A2(_elm_lang$core$Basics$min, n, maximum));
...
var _user$project$Main$statusText = F3(
	function (isBombed, isWin, remaining) {
		return isBombed ? 'Lose!' : (isWin ? 'Win!' : (_elm_lang$core$Native_Utils.eq(remaining, 0) ? A2(
			_elm_lang$core$Basics_ops['++'],
			'Remaining: ',
			_elm_lang$core$Basics$toString(_user$project$Main$bombCount)) : A2(
			_elm_lang$core$Basics_ops['++'],
			'Remaining: ',
			_elm_lang$core$Basics$toString(remaining))));
	});
var _user$project$Main$gridWidth = 30;
var _user$project$Main$gridHeight = 16;
var _user$project$Main$Model = F4(
	function (a, b, c, d) {
		return {secondsElapsed: a, isCounting: b, grid: c, prev: d};
	});
var _user$project$Main$init = {
	...
	_0: A4(
		...
		0,
		false,
		A2(_user$project$Grid$create, _user$project$Main$gridHeight, _user$project$Main$gridWidth),
		_elm_lang$core$Native_List.fromArray(
			[])),
	_1: _elm_lang$core$Platform_Cmd$none
};
var _user$project$Main$None = {ctor: 'None'};
var _user$project$Main$killContext = A3(
	_elm_lang$html$Html_Events$onWithOptions,
	'contextmenu',
	{stopPropagation: false, preventDefault: true},
	_elm_lang$core$Json_Decode$succeed(_user$project$Main$None));
...
var _user$project$Main$face = F2(
	function (isBombed, isWin) {
		return isWin ? A2(
			_elm_lang$html$Html$span,
			_elm_lang$core$Native_List.fromArray(
				[
					_elm_lang$html$Html_Attributes$class('face win'),
			...
			_elm_lang$core$Native_List.fromArray(
				[
					_elm_lang$html$Html_Attributes$class('face sad'),
					_elm_lang$html$Html_Events$onClick(_user$project$Main$Restart)
				]),
			_elm_lang$core$Native_List.fromArray(
				[])) : A2(
			...
			_elm_lang$core$Native_List.fromArray(
				[
					_elm_lang$html$Html_Attributes$class('face happy'),
					_elm_lang$html$Html_Events$onClick(_user$project$Main$Restart)
				]),
			_elm_lang$core$Native_List.fromArray(
				[])));
	});
var _user$project$Main$NeighborClear = F2(
	function (a, b) {
		return {ctor: 'NeighborClear', _0: a, _1: b};
	});
var _user$project$Main$Clear = F2(
	function (a, b) {
		return {ctor: 'Clear', _0: a, _1: b};
	});
var _user$project$Main$SetPlanted = F3(
	function (a, b, c) {
		return {ctor: 'SetPlanted', _0: a, _1: b, _2: c};
	});
			...
			case 'Clear':
				...
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						...
						{
							grid: newGrid,
							isCounting: _elm_lang$core$Basics$not(isBombed || isWin),
							prev: A2(_elm_lang$core$List_ops['::'], model.grid, model.prev)
						}),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			default:
...
var _user$project$Main$Plant = F2(
	function (a, b) {
		return {ctor: 'Plant', _0: a, _1: b};
	});
	...
	function (isBombed, noneUncovered, isWin, grid, y, x, cell) {
		...
		return A2(
			...
			_elm_lang$core$Native_List.fromArray(
				[
					classes,
					A6(_user$project$Main$onCellClick2, isBombed, noneUncovered, isWin, y, x, cell),
					_user$project$Main$killContext
				]),
			_elm_lang$core$Native_List.fromArray(
				[
					A3(
					_user$project$Main$getCellContents,
					cell,
					A3(_user$project$Grid$countNeighborMines, y, x, grid),
					isBombed)
				]));
	});
var _user$project$Main$trow = F6(
	function (isBombed, noneUncovered, isWin, grid, y, row) {
		return A2(
			_elm_lang$html$Html$tr,
			_elm_lang$core$Native_List.fromArray(
				[]),
			A2(
				_user$project$Grid$cellMap,
				A5(_user$project$Main$tcell, isBombed, noneUncovered, isWin, grid, y),
				row));
	});
var _user$project$Main$tgrid = F4(
	function (isBombed, noneUncovered, isWin, grid) {
		return A2(
...
var _user$project$Main$view = function (_p10) {
	var _p11 = _p10;
	var _p12 = _p11.grid;
	var remainingCount = _user$project$Main$bombCount - _user$project$Grid$flagCount(_p12);
	...
	return A2(
		...
		_elm_lang$core$Native_List.fromArray(
			[
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html$text('ELMSWEEPER')
					])),
				A2(
				_elm_lang$html$Html$div,
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html_Attributes$class('grid-wrapper')
					]),
				_elm_lang$core$Native_List.fromArray(
					[
						A2(
						...
						_elm_lang$core$Native_List.fromArray(
							[
								_elm_lang$html$Html_Attributes$class('grid-head')
							]),
						_elm_lang$core$Native_List.fromArray(
							[
								A2(
								...
								_elm_lang$core$Native_List.fromArray(
									[
										_elm_lang$html$Html_Attributes$class('grid-remaining')
									]),
								_elm_lang$core$Native_List.fromArray(
									[
										_elm_lang$html$Html$text(
								...
								_elm_lang$core$Native_List.fromArray(
									[
										_elm_lang$html$Html_Attributes$class('grid-time'),
